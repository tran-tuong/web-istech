      ...
      <div className='container d-flex justify-content-between'>
        ...
        <div className='club-media'>
          <div className='media d-flex'>
            <a href='#' className='wrapper-icon'><FontAwesomeIcon icon={faFacebookF} className='icon' /></a>
            <a href='#' className='wrapper-icon'><FontAwesomeIcon icon={faLinkedinIn} className='icon' /></a>
            <a href='#' className='wrapper-icon'><FontAwesomeIcon icon={faInstagram} className='icon' /></a>
            <a href='#' className='wrapper-icon'><FontAwesomeIcon icon={faEnvelope} className='icon' /></a>
          </div>
