...
export default function About() {
  ...
  return (
    <div className="about">
      ...
      <div>
        <h2 className="text-center ab_value_heading">
          Các <a className="ab_value">giá trị</a> mà chúng tôi theo đuổi
        </h2>
        <div className="container">
          <div className="row">
            <div className="col-4 ab-value-content">
              <div className="ab_item_content">
                <div className="d-flex justify-content-center flex-column align-items-center">
                  <img src="https://uploads-ssl.webflow.com/612b7de9c64ea455b27fc10e/6310c97c52dc930bc2f07e8f_6.%20demonstrating%20integrity-p-500.png"></img>
                  <h3 className="minisub-ab-heading">Thể hiện sự chính trực</h3>
                  <p className="minisub-ab-content">
                    AIESEC đề cao sự nhất quán và minh bạch trong mọi quyết định
                    và hành động của mình. Chúng tôi nghiêm túc thực hiện các
                    cam kết và làm việc đúng theo những quy tắc, thoả thuận được
                    thống nhất bởi các thành viên.
                  </p>
                </div>
              </div>
            </div>
